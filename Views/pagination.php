...
$query = "SELECT questions.*, projects.name as project_name from questions INNER JOIN projects WHERE questions.project_id = projects.id AND archive=0 ORDER BY created_at ASC LIMIT :limit OFFSET :offset";
