...
$query = "SELECT * FROM questions INNER JOIN projects ON questions.project_id = projects.id ORDER BY created_at ASC LIMIT :offset, :limit";
...
<div>
    ...
    $query = "SELECT * FROM questions INNER JOIN projects WHERE questions.project_id = projects.id ORDER BY created_at ASC LIMIT :limit OFFSET :offset";
    ...
    ?>
        <div class="overflow-hidden flex my-4 rounded-lg question myDiv ">
            <div class="flex flex-row items-center">
                ...
                <div class="flex flex-col justify-between mx-3 h-full">
                    ...
                    <div class="flex items-center justify-between">
                        <h3 class="pt-4 text-lg font-light"><?php echo $question['content']; ?></h3>
                    </div>
