        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-white-700 z-40">
            ...
            <div class="p-4 md:p-5 space-y-4">
                ...
                <form action="addAnswer.php" method="POST">
                    ...
                    <button type="submit" class="text-white bg-blue-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
