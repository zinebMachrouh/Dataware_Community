...
=======
        <div>
>>>>>>> c89135c1fa3663a3d651ca8295730de7e7772c9a
            <?php
            ...
            ?>
<<<<<<< HEAD
                <div class="pb-4 flex items-center justify-between my-4 rounded-lg px-3 question">
                    <div class="flex-col">
...
>>>>>>> c89135c1fa3663a3d651ca8295730de7e7772c9a
    ...
    <!-- <form methode="post" action="addAnswer.php"> -->
    <div id="default-modal" tabindex="-1" aria-hidden="true" class="hidden overflow-y-auto overflow-x-hidden fixed top-0 right-0 left-0 z-50 justify-center items-center w-full md:inset-0 h-[calc(100%-1rem)] max-h-full">
        <div class="relative p-4 w-full max-w-2xl max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-white-700 z-40">
                <div class="flex items-center justify-between p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    <h3 class="text-xl font-semibold text-gray-900 dark:text-black question"><?php echo $question['title']; ?></h3>
                ...
                <div class="p-4 md:p-5 space-y-4">
                    <textarea id="modalContent" class="w-full p-2 border rounded-md text-base leading-relaxed text-black dark:text-gray-400 resize-none" rows="5"></textarea>
                </div>
