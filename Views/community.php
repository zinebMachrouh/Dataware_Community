...
<body class="bg-white">
    ...
    <main>
        ...
        <div class="flex gap-2">
            <a href="" class="flex-none border border-gray-300 px-2 py-1 rounded-lg">
                Projects
            ...
            <div class="flex-1 relative">
                ...
                <button type="submit" class="text-white absolute end-2.5 bottom-2.5 bg-blue-700  focus:ring-4  focus:ring-blue-300  rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:focus:ring-blue-800 bg-blue-primary">
                    Search
                </button>
            </div>
        </div>
        <div class="grow border rounded-lg mx-6 mt-10 px-4 pt-2 h-screen">
            ...
            ?>
                ...
                <div class="flex-col">
                    <div class="flex items-center justify-between text-white">
                        <h2 class="pt-4 text-lg text-font-medium"><?php echo $question['title']; ?></h2>
                    </div>
                    <div class="flex items-center justify-between text-white">
                        <h3 class="pt-4 text-lg text-font-medium"><?php echo $question['content']; ?></h2>
                    </div>
                    <div class="p-4 flex items-center gap-10 mt-2 text-white">
                        <!-- <a href="" class="flex items-center border border-gray-300 px-2 py-1 rounded-lg"> -->
                        <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="block text-white border border-gray-300 bg-none hover:bg-blue-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Add Answer +</button>
                            ...
                            <div class="relative p-4 w-full max-w-2xl max-h-full">
                                ...
                                <div class="relative bg-white rounded-lg shadow dark:bg-white-700">
                                    ...
                                    <div class="p-4 md:p-5 space-y-4">
                                        <textarea id="modalContent" class="w-full p-2 border rounded-md text-base leading-relaxed text-black dark:text-gray-400 resize-none" rows="5">
                                        </textarea>
                                    </div>
                                    <!-- Modal footer -->
                                    <div class="flex items-center justify-end p-4 md:p-5 border-t-0 border-gray-200 rounded-b dark:border-gray-600">
                                        <button data-modal-hide="default-modal" type="button" class="text-white bg-blue-300 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                ...
                <div class="flex justify-between gap-10 text-white">
            ...
            <div class="pb-4 flex items-center justify-between border-b-2 border-purp-color">
                <div class="flex-col">
                    <div class="flex items-center justify-between text-white">
                        <h2 class="pt-4 text-lg text-font-medium">What is the main objective of this project?</h2>
                    </div>
                    <div class="p-4 flex items-center gap-10 mt-2 text-white">
                        <!-- <a href="" class="flex items-center border border-gray-300 px-2 py-1 rounded-lg"> -->
                        <button data-modal-target="default-modal" data-modal-toggle="default-modal" class="block text-white border border-gray-300 bg-none hover:bg-blue-300 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Add Answer +</button>
